...
- [ ] Explain what a token is used for.
      A token can be saved in localStorage (or preferrably elsewhere) and verified by our program so we know if they are authenticated and allowed to visit protected pages.

- [ ] What steps can you take in your web apps to keep your data secure?
      You could store the token within the Redux store instead of LocalStorage

- [ ] Describe how web servers work.
      Either a computer that stores the code for a website or a program that runs some code on a computer. The server loads in the code for the website and tells it what to do.
